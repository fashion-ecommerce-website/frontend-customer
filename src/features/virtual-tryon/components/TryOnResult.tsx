      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="pt-8 border-t border-gray-100 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <button
              className="col-span-1 sm:col-span-2 px-6 py-3 bg-white border border-gray-200 text-black font-bold rounded-xl hover:border-black transition-all flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
