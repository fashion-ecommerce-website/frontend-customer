...
import { Review, ApiError, ReviewFormData } from '../types/profile.types';
...
const reviewSlice = createSlice({
  ...
  reducers: {
    ...
    // Update review
    updateReviewRequest: (state, _: PayloadAction<{ reviewId: string; data: ReviewFormData }>) => {
      void _;
    ...
    // Delete review
    deleteReviewRequest: (state, _: PayloadAction<string>) => {
      void _;
      state.isSubmitting = true;
      state.error = null;
    },
