...
export const aoThunSizeChart: SizeChart = {
  ...
  measurements: [
    { size: 'XS', chest: [80, 85], waist: [65, 70], height: [155, 160], shoulder: [40, 42], length: [65, 67] },
    { size: 'S', chest: [86, 91], waist: [71, 76], height: [160, 165], shoulder: [42, 44], length: [67, 69] },
    { size: 'M', chest: [92, 97], waist: [77, 82], height: [165, 170], shoulder: [44, 46], length: [69, 71] },
    { size: 'L', chest: [98, 103], waist: [83, 88], height: [170, 175], shoulder: [46, 48], length: [71, 73] },
    { size: 'XL', chest: [104, 109], waist: [89, 94], height: [175, 180], shoulder: [48, 50], length: [73, 75] },
    { size: 'XXL', chest: [110, 115], waist: [95, 100], height: [180, 185], shoulder: [50, 52], length: [75, 77] },
  ],
  measurementLabels: {
    chest: 'Chest (cm)',
    waist: 'Waist (cm)',
...
export const aoPoloSizeChart: SizeChart = {
  ...
  measurements: [
    { size: 'XS', chest: [82, 87], waist: [67, 72], height: [155, 160], shoulder: [41, 43], length: [66, 68] },
    { size: 'S', chest: [88, 93], waist: [73, 78], height: [160, 165], shoulder: [43, 45], length: [68, 70] },
    { size: 'M', chest: [94, 99], waist: [79, 84], height: [165, 170], shoulder: [45, 47], length: [70, 72] },
    { size: 'L', chest: [100, 105], waist: [85, 90], height: [170, 175], shoulder: [47, 49], length: [72, 74] },
    { size: 'XL', chest: [106, 111], waist: [91, 96], height: [175, 180], shoulder: [49, 51], length: [74, 76] },
    { size: 'XXL', chest: [112, 117], waist: [97, 102], height: [180, 185], shoulder: [51, 53], length: [76, 78] },
  ],
  measurementLabels: {
    chest: 'Chest (cm)',
    waist: 'Waist (cm)',
...
export const aoSomiSizeChart: SizeChart = {
  ...
  measurements: [
    { size: 'XS', chest: [84, 89], waist: [68, 73], height: [155, 160], shoulder: [42, 44], sleeve: [58, 60], length: [70, 72] },
    { size: 'S', chest: [90, 95], waist: [74, 79], height: [160, 165], shoulder: [44, 46], sleeve: [60, 62], length: [72, 74] },
    { size: 'M', chest: [96, 101], waist: [80, 85], height: [165, 170], shoulder: [46, 48], sleeve: [62, 64], length: [74, 76] },
    { size: 'L', chest: [102, 107], waist: [86, 91], height: [170, 175], shoulder: [48, 50], sleeve: [64, 66], length: [76, 78] },
    { size: 'XL', chest: [108, 113], waist: [92, 97], height: [175, 180], shoulder: [50, 52], sleeve: [66, 68], length: [78, 80] },
    { size: 'XXL', chest: [114, 119], waist: [98, 103], height: [180, 185], shoulder: [52, 54], sleeve: [68, 70], length: [80, 82] },
  ],
  measurementLabels: {
    chest: 'Chest (cm)',
    waist: 'Waist (cm)',
...
export const aoHoodieSizeChart: SizeChart = {
  ...
  measurements: [
    { size: 'XS', chest: [88, 93], waist: [70, 75], height: [155, 160], shoulder: [44, 46], length: [62, 64] },
    { size: 'S', chest: [94, 99], waist: [76, 81], height: [160, 165], shoulder: [46, 48], length: [64, 66] },
    { size: 'M', chest: [100, 105], waist: [82, 87], height: [165, 170], shoulder: [48, 50], length: [66, 68] },
    { size: 'L', chest: [106, 111], waist: [88, 93], height: [170, 175], shoulder: [50, 52], length: [68, 70] },
    { size: 'XL', chest: [112, 117], waist: [94, 99], height: [175, 180], shoulder: [52, 54], length: [70, 72] },
    { size: 'XXL', chest: [118, 123], waist: [100, 105], height: [180, 185], shoulder: [54, 56], length: [72, 74] },
  ],
  measurementLabels: {
    chest: 'Chest (cm)',
    waist: 'Waist (cm)',
...
export const quanSizeChart: SizeChart = {
  ...
  measurements: [
    { size: 'XS', waist: [60, 65], hips: [85, 90], inseam: [71, 73], length: [95, 97] },
    { size: 'S', waist: [66, 71], hips: [91, 96], inseam: [74, 76], length: [97, 99] },
    { size: 'M', waist: [72, 77], hips: [97, 102], inseam: [77, 79], length: [99, 101] },
    { size: 'L', waist: [78, 83], hips: [103, 108], inseam: [80, 82], length: [101, 103] },
    { size: 'XL', waist: [84, 89], hips: [109, 114], inseam: [83, 85], length: [103, 105] },
    { size: 'XXL', waist: [90, 95], hips: [115, 120], inseam: [86, 88], length: [105, 107] },
  ],
  measurementLabels: {
    waist: 'Waist (cm)',
    hips: 'Hips (cm)',
...
export const quanJoggerSizeChart: SizeChart = {
  ...
  measurements: [
    { size: 'XS', waist: [62, 67], hips: [87, 92], inseam: [70, 72], length: [93, 95] },
    { size: 'S', waist: [68, 73], hips: [93, 98], inseam: [72, 74], length: [95, 97] },
    { size: 'M', waist: [74, 79], hips: [99, 104], inseam: [74, 76], length: [97, 99] },
    { size: 'L', waist: [80, 85], hips: [105, 110], inseam: [76, 78], length: [99, 101] },
    { size: 'XL', waist: [86, 91], hips: [111, 116], inseam: [78, 80], length: [101, 103] },
    { size: 'XXL', waist: [92, 97], hips: [117, 122], inseam: [80, 82], length: [103, 105] },
  ],
  measurementLabels: {
    waist: 'Waist (cm)',
    hips: 'Hips (cm)',
