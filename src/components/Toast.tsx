...
export const Toast: React.FC<ToastProps> = ({ 
  ...
  const getToastStyles = () => {
    const baseStyles = "fixed top-10 right-4 z-50 w-full max-w-md border rounded-lg shadow-lg p-4 pointer-events-auto transform transition-all duration-300 ease-in-out";
