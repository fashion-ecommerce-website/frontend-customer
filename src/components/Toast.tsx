...
export const Toast: React.FC<ToastProps> = ({ 
  ...
  const getToastStyles = () => {
    const baseStyles = "fixed top-8 sm:top-10 right-2 sm:right-4 z-50 w-[calc(100vw-16px)] sm:w-full max-w-xs sm:max-w-md border rounded-lg shadow-lg p-3 sm:p-4 pointer-events-auto transform transition-all duration-300 ease-in-out";
