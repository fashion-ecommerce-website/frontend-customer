...
interface GoogleAuthProps {
  ...
  hideWhenAuthenticated?: boolean; // Ẩn hoàn toàn component khi đã đăng nhập
}
...
export const GoogleAuth: React.FC<GoogleAuthProps> = ({ 
  ...
  if (isAuthenticated && user) {
    // Nếu muốn ẩn khi đã đăng nhập (dành cho trang login) - NHƯNG vẫn hiển thị button login
    if (hideWhenAuthenticated) {
      // Thay vì ẩn hoàn toàn, hiển thị button login để có thể đăng nhập tài khoản khác
      return (
        <button 
          type="button" 
